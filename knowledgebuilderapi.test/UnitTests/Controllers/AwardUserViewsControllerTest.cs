...
namespace knowledgebuilderapi.test.unittest
{
    ...
    public class AwardUserViewsControllerTest : IDisposable
    {
        SqliteDatabaseFixture fixture = null;

        public AwardUserViewsControllerTest(SqliteDatabaseFixture fixture)
        {
        ...
        public async Task TestCase_GetList(String usr)
        {
            ...
            var control = new AwardUserViewsController(context);
